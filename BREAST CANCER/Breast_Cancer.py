...
def Logistic_Regression():
    if upload is not None:
        ...
        def data_input():
            ...
            data= DataFrame({'radius_mean':[radius_mean],'texture_se':[texture_se],'radius_worst':[radius_worst],'concavity_worst':[concavity_worst],'concave points_worst':[concave_points]})
            return data
